...
import 'package:thirty_days/widgets/home/appFeedWidget.dart';
import 'package:thirty_days/widgets/home/profileWidget.dart';
    ...
    return Scaffold(
      body: PageView(
        ...
        children: [
          ...
          Center(
              child: Text(
                  'Shopping Widget Placeholder')),
          Center(
              child: Text(
                  'My Store Widget Placeholder')), 
